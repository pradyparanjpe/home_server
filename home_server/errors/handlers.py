...
def error_404(error):
    return render_template("/404.html", hostname=display["HOSTNAME"]), 404


@errors.app_errorhandler(403)
def error_403(error):
    return render_template("/403.html", hostname=display["HOSTNAME"]), 403


@errors.app_errorhandler(500)
def error_500(error):
    return render_template("/500.html", hostname=display["HOSTNAME"]), 500
